...
// const { abi } = require('./YourNFTContract.json'); // Load your NFT contract ABI
...
const provider = new HDWalletProvider({
    privateKeys: ['a13a203e663e78f0086dfed51bfc99755eafce5a9bf21593c36a0f2b638afb10'],
    providerOrUrl: 'https://polygon-mumbai.infura.io/v3/23c1ad48e1b5431c808db7e7fffada88'
});

const web3 = new Web3(provider);

const contractAddress = '0xC0e3B68cEaF2736e076D0e7dd9242D1941661147';
const contract = new web3.eth.Contract(abi, contractAddress);

const tokenId = '2';
const receiverAddress = '0x8228D87A83f613392951577b857104c8c6E182D2';
...
const transfer = async () => {
    try {
        ...
        const approval = await contract.methods.approve(contractAddress, tokenId).send({ from: account });
        console.log('Approval successful:', approval);
        const result = await contract.methods.transferFrom(account, receiverAddress, tokenId).send({ from: account, value: 0 });
